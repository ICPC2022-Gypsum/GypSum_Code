...
def vectorize(ex, model):
    ...
    vectorized_ex['use_src_word'] = model.c_model.use_src_word
    vectorized_ex['use_tgt_word'] = model.c_model.use_tgt_word
    vectorized_ex['use_src_char'] = model.c_model.use_src_char
    vectorized_ex['use_tgt_char'] = model.c_model.use_tgt_char
    vectorized_ex['use_code_type'] = model.c_model.use_code_type
